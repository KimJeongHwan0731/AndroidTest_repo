...
class SubActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvMessage.setTextColor(Color.parseColor("#FF6EED"))
        tvMessage.textSize = 20.0f
        ...
        btnClick.text = "클릭해 주세요"
        btnClick.setOnClickListener {
            Toast.makeText(applicationContext, "김정환님 반갑습니다", Toast.LENGTH_SHORT).show()
            if (flag == true) {
        ...
        val liLayout = LinearLayout(this).apply {
            ...
            setBackgroundColor(Color.parseColor("#FFF064"))
